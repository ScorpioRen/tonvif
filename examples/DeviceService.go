...
import (
	...
	goonvif "github.com/ScorpioRen/tonvif"
	"github.com/ScorpioRen/tonvif/device"
	"github.com/ScorpioRen/tonvif/gosoap"
	"github.com/ScorpioRen/tonvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/ScorpioRen/tonvif/gosoap for pretty printing response
		*/
